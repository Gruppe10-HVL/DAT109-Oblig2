...
public class Dummy {
    ...
    public static Map<String, Vehicle> dummyVehicleList2() {
        ...
        dummyVehicles.put("ST22", new Vehicle("ST22", "Audi", "A2", Group.MEDIUM, 254000));
        ...
        dummyVehicles.put("ST52", new Vehicle("ST52", "Peugot", "307", Group.MEDIUM, 32000));
        dummyVehicles.put("ST62", new Vehicle("ST62", "Seat", "fiesta", Group.MEDIUM, 41000));
        dummyVehicles.put("ST72", new Vehicle("ST72", "VW", "boble", Group.MEDIUM, 214200));
        dummyVehicles.put("ST82", new Vehicle("ST82", "Porsche", "Spyder", Group.MEDIUM, 1422000));
    ...
    public static Map<String, Vehicle> dummyVehicleList3() {
        ...
        dummyVehicles.put("ST23", new Vehicle("ST23", "Audi", "A2", Group.MEDIUM, 254000));
        ...
        dummyVehicles.put("ST53", new Vehicle("ST53", "Peugot", "307", Group.MEDIUM, 32000));
        dummyVehicles.put("ST63", new Vehicle("ST63", "Seat", "fiesta", Group.MEDIUM, 41000));
        dummyVehicles.put("ST73", new Vehicle("ST73", "VW", "boble", Group.MEDIUM, 214200));
        dummyVehicles.put("ST83", new Vehicle("ST83", "Porsche", "Spyder", Group.MEDIUM, 1422000));
    ...
    public static Map<String, Vehicle> dummyVehicleList4() {
        ...
        dummyVehicles.put("ST24", new Vehicle("ST24", "Audi", "A2", Group.MEDIUM, 254000));
        ...
        dummyVehicles.put("ST54", new Vehicle("ST54", "Peugot", "307", Group.MEDIUM, 32000));
        dummyVehicles.put("ST64", new Vehicle("ST64", "Seat", "fiesta", Group.MEDIUM, 41000));
        dummyVehicles.put("ST74", new Vehicle("ST74", "VW", "boble", Group.MEDIUM, 214200));
        dummyVehicles.put("ST84", new Vehicle("ST84", "Porsche", "Spyder", Group.MEDIUM, 1422000));
